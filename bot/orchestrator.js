...
ВАЖЛИВО — БЮДЖЕТ:
Користувач вказує бюджет у доларах ($).
Курс конвертації: 1 USD = 41 UAH.
daily_budget передається в копійках (UAH × 100).
Формула: daily_budget = $ × 41 × 100

Приклади:
  $5/день  → daily_budget: 20500
  $10/день → daily_budget: 41000
  $15/день → daily_budget: 61500
  $20/день → daily_budget: 82000
  $25/день → daily_budget: 102500
  $30/день → daily_budget: 123000
  $50/день → daily_budget: 205000

В превью показуй бюджет у доларах: "Бюджет: $20/день".
